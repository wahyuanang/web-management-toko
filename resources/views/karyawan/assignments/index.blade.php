                            ...
                            <div class="grid grid-cols-2 gap-3 text-sm">
                                ...
                                <div>
                                    ...
                                    @if ($assignment->deadline)
                                        <span
                                            class="text-gray-900 font-medium block">{{ $assignment->deadline->format('d M Y') }}</span>
                                        <span
                                            class="text-xs text-gray-500">{{ $assignment->deadline->format('H:i') }}</span>
                                    @else
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if ($assignment->deadline)
                                        <div>
                                            <span
                                                class="text-sm text-gray-900 block">{{ $assignment->deadline->format('d M Y') }}</span>
                                            <span
                                                class="text-xs text-gray-500">{{ $assignment->deadline->format('H:i') }}</span>
                                        </div>
                                    @else

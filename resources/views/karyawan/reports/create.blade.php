    ...
    <div class="space-y-6">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="mt-2 text-yellow-700">
                            Saat ini tidak ada tugas yang dapat dilaporkan. Semua tugas yang ditugaskan kepada Anda sudah
                            selesai diantar.
                        </p>
                        <div class="mt-4">
        ...
        @else
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <form method="POST" action="{{ route('karyawan.reports.store') }}" enctype="multipart/form-data"
                    class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_barang_dikirim" id="jumlah_barang_dikirim"
                            value="{{ old('jumlah_barang_dikirim') }}" min="1" required
                    ...
                    <!-- Perhitungan Harga (Display Only) -->
                    <div id="price-section" class="hidden bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                        <h3 class="text-sm font-semibold text-blue-900 mb-3">Perhitungan Harga</h3>
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                <span class="text-blue-700">Harga per <span id="satuan-display">unit</span>:</span>
                                <span class="font-semibold text-blue-900" id="harga-display">Rp 0</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-blue-700">Jumlah barang:</span>
                                <span class="font-semibold text-blue-900" id="qty-display">0 unit</span>
                            </div>
                            <div class="border-t-2 border-blue-200 pt-2 mt-2">
                                <div class="flex justify-between items-center">
                                    <span class="text-blue-900 font-semibold text-base">Total Harga:</span>
                                    <span class="font-bold text-blue-900 text-lg" id="total-display">Rp 0</span>
                                </div>
                            </div>
                    ...
                    <input type="hidden" name="harga_per_pcs" id="harga_per_pcs" value="0">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="foto_bukti"
                                        ...
                                        <input id="foto_bukti" name="foto_bukti" type="file"
                                            ...
                                            onchange="previewImage(this, 'preview1')" class="sr-only">
                                    </label>
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="foto_bukti_2"
                                        ...
                                        <input id="foto_bukti_2" name="foto_bukti_2" type="file"
                                            ...
                                            onchange="previewImage(this, 'preview2')" class="sr-only">
                                    </label>
                                    <p class="pl-1">atau drag and drop</p>
                                </div>
                                <p class="text-xs text-gray-500">PNG, JPG, JPEG maksimal 2MB</p>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="waktu_laporan" id="waktu_laporan"
                            value="{{ old('waktu_laporan', now()->format('Y-m-d\TH:i')) }}" required
                    ...
                    fetch(`/karyawan/api/assignments/${assignmentId}`)
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                // Set harga per pcs dari product
